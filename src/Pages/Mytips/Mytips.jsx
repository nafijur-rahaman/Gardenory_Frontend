  ...
  return (
    <div className="p-8 bg-green-50 dark:bg-gray-900 min-h-screen py-12">
      <div className="max-w-6xl mx-auto bg-white dark:bg-gray-800 shadow-xl rounded-3xl p-8 border border-green-200 dark:border-gray-700">
        <h2 className="text-3xl font-extrabold mb-8 text-green-700 dark:text-green-400 flex items-center gap-3">
          My Tips
        </h2>

        <div className="overflow-x-auto rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
          <table className="w-full table-auto border-collapse">
            <thead className="bg-green-700 dark:bg-green-600 text-white uppercase tracking-wide select-none">
              <tr>
            ...
            <tbody>
              ...
              {tips.map((tip) => (
                <tr
                  key={tip._id}
                  className="border-b hover:bg-green-50 dark:hover:bg-gray-700 transition-colors duration-200 cursor-default"
                >
                  <td className="p-4 text-gray-800 dark:text-gray-200 font-medium">
                    {tip.title}
                  </td>
                  <td className="p-4 text-gray-700 dark:text-gray-300">{tip.category}</td>
                  <td className="p-4 text-gray-700 dark:text-gray-300">{tip.availability}</td>
                  <td className="p-4 flex justify-center gap-4">
                    <button
                      ...
                      aria-label={`Update tip ${tip.title}`}
                    >
                      <FaEdit />
                      <span>Update</span>
                    </button>
            ...
            <div className="fixed inset-0 flex items-center justify-center z-[60]">
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl max-w-md w-full p-6 border border-gray-300 dark:border-gray-700">
                ...
                <div className="flex justify-end gap-4">
                  <button
                    onClick={deleteTip}
                    className="bg-red-600 hover:bg-red-700 text-white px-5 py-2 rounded-lg font-semibold transition focus:outline-none focus:ring-2 focus:ring-red-400"
                  >
                    Delete
                  </button>
                  <button
                    onClick={() => setShowConfirm(false)}
                    className="bg-gray-300 hover:bg-gray-400 text-gray-800 dark:text-gray-200 px-5 py-2 rounded-lg font-semibold transition focus:outline-none focus:ring-2 focus:ring-gray-400"
                  >
                    Cancel
                  </button>
                </div>
